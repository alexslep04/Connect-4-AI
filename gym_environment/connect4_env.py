...
import numpy as np
from pygame.connect4_game import Connect4Game
...
class Connect4Env(gym.Env):
    ...
    def step(self, action):
        ...
        try:
            ...
            # If action is invalid (i.e., the column is full), assign a negative reward and end the game
            return self.game.board, -1, True, {}  # Invalid action should penalize the AI
